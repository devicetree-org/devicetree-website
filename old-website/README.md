...
Hosted in this repo are the markdown content files associated with the website. Feel free to [submit a PR](https://github.com/devicetree-org/devicetree-website/pulls) / [Issue](https://github.com/devicetree-org/devicetree-website/issues/new) if there is anything you would like to change.
